...
class File_Model:
    ...
    def save_as(self,msg):
        ...
        self.url=filedialog.asksaveasfile(mode="w",defaultextension='.ntxt',filetypes=[("All Files","*.*"),("Text Documents","*.*")])
    ...
    def save_file(self,msg):
        if self.url=="":
            self.url=filedialog.asksaveasfilename(title="Select file name",defaultextension='.ntxt',filetypes=[("Text Documents","*.*")])
